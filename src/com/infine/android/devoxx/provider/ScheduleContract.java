...
public class ScheduleContract {
    ...
    interface BlocksColumns {
        ...
        /** Type describing this block. */
//        String BLOCK_SPONSORED = "block_sponsored";
    ...
    interface TweetsColumns {
    	...
    	/** text of the tweet (content). */
    	String TEXT = "tweet_text";
    	/** date of publishing. */
    ...
    interface SessionsColumns {
        ...
        /** Session's theme. */
        String SESSION_THEME = "session_theme";
        /** Session's room. */
        String SESSION_ROOM = "session_room";
        /** Session's summary. */
        String SESSION_SUMMARY = "session_summary";
        /** Kewords/tags for this session. */
        String SESSION_TAGS = "session_tags";
        /** Full URL to session rest info online. */
        String SESSION_URL = "session_url";
        /** Full URL to session rest info online. */
        String SESSION_SPEAKERS = "session_speakers";
        ...
        /** Is the session sponsored */
        String SESSION_SPONSORED = "session_sponsored";
    }
//    interface SessionsColumns {
//        /** Unique string identifying this session. */
//        String SESSION_ID = "session_id";
...
//    }
    ...
    interface SpeakersColumns {
        ...
        /** Full URL to the speaker's profile. */
        String SPEAKER_SESSIONS = "speaker_sessions";
    }
    ...
    public static final String CONTENT_AUTHORITY = "com.infine.android.devoxx";
    ...
    public static class Blocks implements BlocksColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.block";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.block";
        ...
        public static final String COUNT_STARRED = "count_starred";
        
        public static final String TITLE_STARRED = "title_starred";
    ...
    public static class Tracks implements TracksColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.track";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.track";
   ...
   /**
    * Tweets retrieve from Twitter rest api
    */
    public static class Tweets implements TweetsColumns, BaseColumns {
    	public static final Uri CONTENT_URI =
    			BASE_CONTENT_URI.buildUpon().appendPath(PATH_TWEETS).build();
    	
    	public static final String CONTENT_TYPE =
    			"vnd.android.cursor.dir/vnd.devoxxfr.tweet";
    	public static final String CONTENT_ITEM_TYPE =
    			"vnd.android.cursor.item/vnd.devoxxfr.tweet";
    	
    	    	
    	/** Default "ORDER BY" clause. */
    	public static final String DEFAULT_SORT = TweetsColumns.CREATION_DATE + " DESC";
    	...
    	/** Read {@link #TWEET_ID} from {@link Tracks} {@link Uri}. */
    ...
    public static class Rooms implements RoomsColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.room";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.room";

        /** Default "ORDER BY" clause. */
        public static final String DEFAULT_SORT = RoomsColumns.ROOM_NAME + " COLLATE NOCASE ASC";
    ...
    public static class Sessions implements SessionsColumns, BlocksColumns, RoomsColumns,
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.session";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.session";
    ...
    public static class Speakers implements SpeakersColumns, SyncColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.speaker";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.speaker";
    ...
    public static class Vendors implements VendorsColumns, SyncColumns, BaseColumns {
        ...
        public static final String CONTENT_TYPE =
                "vnd.android.cursor.dir/vnd.devoxxfr.vendor";
        public static final String CONTENT_ITEM_TYPE =
                "vnd.android.cursor.item/vnd.devoxxfr.vendor";
