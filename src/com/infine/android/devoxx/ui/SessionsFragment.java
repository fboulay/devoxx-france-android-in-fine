...
//			AnalyticsUtils.getInstance(getActivity()).trackPageView("/Tracks/" + trackName);
	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		final String sessionId = cursor.getString(cursor.getColumnIndex(ScheduleContract.Sessions.SESSION_ID));
	...
	private interface SessionsQuery {
		...
		String[] PROJECTION = { BaseColumns._ID, ScheduleContract.Sessions.SESSION_ID,
				ScheduleContract.Sessions.SESSION_TITLE, ScheduleContract.Sessions.SESSION_STARRED,
				ScheduleContract.Blocks.BLOCK_START, ScheduleContract.Blocks.BLOCK_END,
				ScheduleContract.Rooms.ROOM_NAME, ScheduleContract.Sessions.SESSION_THEME};
	...
	/**
	 * {@link com.infine.android.devoxx.provider.ScheduleContract.Tracks} query
	 * parameters.
	 */
	private interface TracksQuery {
		int _TOKEN = 0x2;

		String[] PROJECTION = { ScheduleContract.Tracks.TRACK_NAME, ScheduleContract.Tracks.TRACK_COLOR, };
	...
	private interface SearchQuery {
		...
		String[] PROJECTION = { BaseColumns._ID, ScheduleContract.Sessions.SESSION_ID,
				ScheduleContract.Sessions.SESSION_TITLE, ScheduleContract.Sessions.SEARCH_SNIPPET,
