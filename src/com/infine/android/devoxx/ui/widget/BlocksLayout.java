...
//        addView(blockView, 1);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            // calcul les dimensions du block
            if (child instanceof BlockView) {
            	
                final BlockView blockView = (BlockView) child;
                int offsetColumn = blockView.getColumn().getNumColumn();
                int maxColumns = blockView.getColumn().getColspan();
                ...
                int left = headerWidth + (columnWidth * offsetColumn);
                int right = left + (columnWidth * maxColumns);
